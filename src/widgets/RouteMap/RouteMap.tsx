    ...
    const routeStages = [
        {
            ...
            distance: "22.5 km",
            description: "Starting point at the city beach, heading towards the first checkpoint",
        ...
        },
        {
            ...
            distance: "19 km",
            description: "Continuing through scenic river sections with moderate currents",
        ...
        },
        {
            ...
            distance: "35 km",
            description: "The longest single-day stretch through challenging open waters",
        ...
        },
        {
            ...
            distance: "32 km",
            description: "Technical section with varying water conditions and navigation challenges",
                ...
                <div className={styles.routeGrid}>
                    {routeStages.map((stage) => (
                        <div key={stage.day} className={styles.routeCard}>
                            ...
                            <div className={styles.cardContent}>
                                ...
                                <h3 className={styles.routeTitle}>{stage.route}</h3>
                                <div className={styles.distance}>{stage.distance}</div>
                    ...
                    <div className={`${styles.routeCard} ${styles.totalCard}`}>
                        ...
                        <div className={styles.cardContent}>
                            ...
                            <h3 className={styles.totalTitle}>Complete Challenge</h3>
                            <div className={styles.totalDistance}>150 km</div>
                            <p className={styles.totalDescription}>
                                Epic 5-day swimming adventure across the mighty Volga River
                            </p>
                        </div>
                    </div>
                </div>
